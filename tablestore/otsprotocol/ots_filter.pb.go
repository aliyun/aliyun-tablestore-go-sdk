...
func (VariantType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_ots_filter_1a3ed6cfea5fa163, []int{0}
}
...
func (FilterType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_ots_filter_1a3ed6cfea5fa163, []int{1}
}
...
func (ComparatorType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_ots_filter_1a3ed6cfea5fa163, []int{2}
}
...
func (LogicalOperator) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_ots_filter_1a3ed6cfea5fa163, []int{3}
}
...
func (dst *ValueTransferRule) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ValueTransferRule.Merge(dst, src)
}
...
func (dst *SingleColumnValueFilter) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SingleColumnValueFilter.Merge(dst, src)
}
...
func (dst *CompositeColumnValueFilter) XXX_Merge(src proto.Message) {
	xxx_messageInfo_CompositeColumnValueFilter.Merge(dst, src)
}
...
func (dst *ColumnPaginationFilter) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ColumnPaginationFilter.Merge(dst, src)
}
...
func (*Filter) Descriptor() ([]byte, []int) {
	return fileDescriptor_ots_filter_1a3ed6cfea5fa163, []int{4}
}
...
func init() { proto.RegisterFile("ots_filter.proto", fileDescriptor_ots_filter_1a3ed6cfea5fa163) }

var fileDescriptor_ots_filter_1a3ed6cfea5fa163 = []byte{
