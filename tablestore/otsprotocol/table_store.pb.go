...
const (
	NewRowReturnPolicy_NO_NEW_ROW   NewRowReturnPolicy = 1
	NewRowReturnPolicy_WITH_NEW_ROW NewRowReturnPolicy = 2
	NewRowReturnPolicy_NEW_ROW_ONLY NewRowReturnPolicy = 3
)

var NewRowReturnPolicy_name = map[int32]string{
	1: "NO_NEW_ROW",
	2: "WITH_NEW_ROW",
	3: "NEW_ROW_ONLY",
}

var NewRowReturnPolicy_value = map[string]int32{
	"NO_NEW_ROW":   1,
	"WITH_NEW_ROW": 2,
	"NEW_ROW_ONLY": 3,
}

func (x NewRowReturnPolicy) Enum() *NewRowReturnPolicy {
	p := new(NewRowReturnPolicy)
	*p = x
	return p
}

func (x NewRowReturnPolicy) String() string {
	return proto.EnumName(NewRowReturnPolicy_name, int32(x))
}

func (x *NewRowReturnPolicy) UnmarshalJSON(data []byte) error {
	value, err := proto.UnmarshalJSONEnum(NewRowReturnPolicy_value, data, "NewRowReturnPolicy")
	if err != nil {
		return err
	}
	*x = NewRowReturnPolicy(value)
	return nil
}

func (NewRowReturnPolicy) EnumDescriptor() ([]byte, []int) {
...
const (
	...
	SQLStatementType_SQL_INSERT         SQLStatementType = 7
	SQLStatementType_SQL_UPDATE         SQLStatementType = 8
	SQLStatementType_SQL_DELETE         SQLStatementType = 9
)
...
type TableOptions struct {
	...
	UpdateFullRow             *bool            `protobuf:"varint,7,opt,name=update_full_row,json=updateFullRow" json:"update_full_row,omitempty"`
	XXX_NoUnkeyedLiteral      struct{}         `json:"-"`
	XXX_unrecognized          []byte           `json:"-"`
	XXX_sizecache             int32            `json:"-"`
}
...
func (m *TableOptions) GetUpdateFullRow() bool {
	if m != nil && m.UpdateFullRow != nil {
		return *m.UpdateFullRow
	}
	return false
}
...
type TableMeta struct {
	...
	GlobalTableId        *string                `protobuf:"bytes,6,opt,name=global_table_id,json=globalTableId" json:"global_table_id,omitempty"`
	GlobalTableSourceId  *string                `protobuf:"bytes,7,opt,name=global_table_source_id,json=globalTableSourceId" json:"global_table_source_id,omitempty"`
	XXX_NoUnkeyedLiteral struct{}               `json:"-"`
	XXX_unrecognized     []byte                 `json:"-"`
	XXX_sizecache        int32                  `json:"-"`
}
...
func (m *TableMeta) GetTableId() string {
...
func (m *TableMeta) GetGlobalTableId() string {
...
func (m *TableMeta) GetGlobalTableSourceId() string {
	if m != nil && m.GlobalTableSourceId != nil {
		return *m.GlobalTableSourceId
	}
	return ""
}
...
type RowInBatchWriteRowRequest struct {
	...
	Condition            *Condition     `protobuf:"bytes,3,req,name=condition" json:"condition,omitempty"`
	ReturnContent        *ReturnContent `protobuf:"bytes,4,opt,name=return_content,json=returnContent" json:"return_content,omitempty"`
	RowVersion           *int64         `protobuf:"varint,5,opt,name=row_version,json=rowVersion" json:"row_version,omitempty"`
	SourceId             []byte         `protobuf:"bytes,6,opt,name=source_id,json=sourceId" json:"source_id,omitempty"`
	XXX_NoUnkeyedLiteral struct{}       `json:"-"`
	XXX_unrecognized     []byte         `json:"-"`
	XXX_sizecache        int32          `json:"-"`
}
...
func (m *RowInBatchWriteRowRequest) GetRowVersion() int64 {
	if m != nil && m.RowVersion != nil {
		return *m.RowVersion
	}
	return 0
}

func (m *RowInBatchWriteRowRequest) GetSourceId() []byte {
	if m != nil {
		return m.SourceId
	}
	return nil
...
type GetStreamRecordRequest struct {
	...
	NewRowReturnPolicy   *NewRowReturnPolicy `protobuf:"varint,4,opt,name=new_row_return_policy,json=newRowReturnPolicy,enum=otsprotocol.NewRowReturnPolicy" json:"new_row_return_policy,omitempty"`
	ReturnSysColumns     *bool               `protobuf:"varint,5,opt,name=return_sys_columns,json=returnSysColumns" json:"return_sys_columns,omitempty"`
	XXX_NoUnkeyedLiteral struct{}            `json:"-"`
	XXX_unrecognized     []byte              `json:"-"`
	XXX_sizecache        int32               `json:"-"`
}
...
func (m *GetStreamRecordRequest) GetNewRowReturnPolicy() NewRowReturnPolicy {
	if m != nil && m.NewRowReturnPolicy != nil {
		return *m.NewRowReturnPolicy
	}
	return NewRowReturnPolicy_NO_NEW_ROW
}

func (m *GetStreamRecordRequest) GetReturnSysColumns() bool {
	if m != nil && m.ReturnSysColumns != nil {
		return *m.ReturnSysColumns
	}
	return false
}
...
type GetStreamRecordResponse struct {
	...
	VersionGeneratorValue *int64                                  `protobuf:"varint,5,opt,name=version_generator_value,json=versionGeneratorValue" json:"version_generator_value,omitempty"`
	XXX_NoUnkeyedLiteral  struct{}                                `json:"-"`
	XXX_unrecognized      []byte                                  `json:"-"`
	XXX_sizecache         int32                                   `json:"-"`
}
...
func (m *GetStreamRecordResponse) GetVersionGeneratorValue() int64 {
	if m != nil && m.VersionGeneratorValue != nil {
		return *m.VersionGeneratorValue
	}
	return 0
}

type GetStreamRecordResponse_NewRowInfo struct {
	HasNewRow            *bool    `protobuf:"varint,1,opt,name=has_new_row,json=hasNewRow" json:"has_new_row,omitempty"`
	Columns              []byte   `protobuf:"bytes,2,opt,name=columns" json:"columns,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}

func (m *GetStreamRecordResponse_NewRowInfo) Reset()         { *m = GetStreamRecordResponse_NewRowInfo{} }
func (m *GetStreamRecordResponse_NewRowInfo) String() string { return proto.CompactTextString(m) }
func (*GetStreamRecordResponse_NewRowInfo) ProtoMessage()    {}
func (*GetStreamRecordResponse_NewRowInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_f723cea3e4fa0cb7, []int{60, 0}
}

func (m *GetStreamRecordResponse_NewRowInfo) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_GetStreamRecordResponse_NewRowInfo.Unmarshal(m, b)
}
func (m *GetStreamRecordResponse_NewRowInfo) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_GetStreamRecordResponse_NewRowInfo.Marshal(b, m, deterministic)
}
func (m *GetStreamRecordResponse_NewRowInfo) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GetStreamRecordResponse_NewRowInfo.Merge(m, src)
}
func (m *GetStreamRecordResponse_NewRowInfo) XXX_Size() int {
	return xxx_messageInfo_GetStreamRecordResponse_NewRowInfo.Size(m)
}
func (m *GetStreamRecordResponse_NewRowInfo) XXX_DiscardUnknown() {
	xxx_messageInfo_GetStreamRecordResponse_NewRowInfo.DiscardUnknown(m)
}

var xxx_messageInfo_GetStreamRecordResponse_NewRowInfo proto.InternalMessageInfo

func (m *GetStreamRecordResponse_NewRowInfo) GetHasNewRow() bool {
	if m != nil && m.HasNewRow != nil {
		return *m.HasNewRow
	}
	return false
}

func (m *GetStreamRecordResponse_NewRowInfo) GetColumns() []byte {
	if m != nil {
		return m.Columns
	}
	return nil
...
type GetStreamRecordResponse_StreamRecord struct {
	...
	VersionGeneratorValue *int64                              `protobuf:"varint,5,opt,name=version_generator_value,json=versionGeneratorValue" json:"version_generator_value,omitempty"`
	NewRowInfo            *GetStreamRecordResponse_NewRowInfo `protobuf:"bytes,6,opt,name=new_row_info,json=newRowInfo" json:"new_row_info,omitempty"`
	SysColumns            []byte                              `protobuf:"bytes,7,opt,name=sys_columns,json=sysColumns" json:"sys_columns,omitempty"`
	XXX_NoUnkeyedLiteral  struct{}                            `json:"-"`
	XXX_unrecognized      []byte                              `json:"-"`
	XXX_sizecache         int32                               `json:"-"`
}
...
func (*GetStreamRecordResponse_StreamRecord) Descriptor() ([]byte, []int) {
	return fileDescriptor_f723cea3e4fa0cb7, []int{60, 1}
}
...
func (m *GetStreamRecordResponse_StreamRecord) GetTableName() []byte {
	if m != nil {
		return m.TableName
	}
	return nil
...
func (m *GetStreamRecordResponse_StreamRecord) GetVersionGeneratorValue() int64 {
	if m != nil && m.VersionGeneratorValue != nil {
		return *m.VersionGeneratorValue
	}
	return 0
...
func (m *GetStreamRecordResponse_StreamRecord) GetNewRowInfo() *GetStreamRecordResponse_NewRowInfo {
	if m != nil {
		return m.NewRowInfo
	}
	return nil
...
func (m *GetStreamRecordResponse_StreamRecord) GetSysColumns() []byte {
	if m != nil {
		return m.SysColumns
	}
	return nil
...
type IndexMeta struct {
	...
	IndexSyncPhase       *IndexSyncPhase  `protobuf:"varint,6,opt,name=index_sync_phase,json=indexSyncPhase,enum=otsprotocol.IndexSyncPhase" json:"index_sync_phase,omitempty"`
	XXX_NoUnkeyedLiteral struct{}         `json:"-"`
	XXX_unrecognized     []byte           `json:"-"`
	XXX_sizecache        int32            `json:"-"`
}
...
func (m *DescribeTableInnerInfo) Reset()         { *m = DescribeTableInnerInfo{} }
func (m *DescribeTableInnerInfo) String() string { return proto.CompactTextString(m) }
func (*DescribeTableInnerInfo) ProtoMessage()    {}
func (*DescribeTableInnerInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_f723cea3e4fa0cb7, []int{65}
}

func (m *DescribeTableInnerInfo) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_DescribeTableInnerInfo.Unmarshal(m, b)
}
func (m *DescribeTableInnerInfo) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_DescribeTableInnerInfo.Marshal(b, m, deterministic)
}
func (m *DescribeTableInnerInfo) XXX_Merge(src proto.Message) {
	xxx_messageInfo_DescribeTableInnerInfo.Merge(m, src)
}
func (m *DescribeTableInnerInfo) XXX_Size() int {
	return xxx_messageInfo_DescribeTableInnerInfo.Size(m)
}
func (m *DescribeTableInnerInfo) XXX_DiscardUnknown() {
	xxx_messageInfo_DescribeTableInnerInfo.DiscardUnknown(m)
}

var xxx_messageInfo_DescribeTableInnerInfo proto.InternalMessageInfo

func (m *DescribeTableInnerInfo) GetClusterName() string {
...
type SQLQueryRequest struct {
	...
	SearchToken          *string            `protobuf:"bytes,5,opt,name=search_token,json=searchToken" json:"search_token,omitempty"`
	XXX_NoUnkeyedLiteral struct{}           `json:"-"`
	XXX_unrecognized     []byte             `json:"-"`
	XXX_sizecache        int32              `json:"-"`
}
...
type SQLQueryResponse struct {
	...
	AffectedRows         *int64                    `protobuf:"varint,6,opt,name=affected_rows,json=affectedRows" json:"affected_rows,omitempty"`
	NextSearchToken      *string                   `protobuf:"bytes,8,opt,name=next_search_token,json=nextSearchToken" json:"next_search_token,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                  `json:"-"`
	XXX_unrecognized     []byte                    `json:"-"`
	XXX_sizecache        int32                     `json:"-"`
}
...
func (*SQLQueryResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_f723cea3e4fa0cb7, []int{86}
}
...
func (m *SQLQueryResponse) GetAffectedRows() int64 {
...
func init() {
	...
	proto.RegisterEnum("otsprotocol.NewRowReturnPolicy", NewRowReturnPolicy_name, NewRowReturnPolicy_value)
	...
	proto.RegisterType((*GetStreamRecordResponse_NewRowInfo)(nil), "otsprotocol.GetStreamRecordResponse.NewRowInfo")
	...
	proto.RegisterType((*DescribeTableInnerInfo)(nil), "otsprotocol.DescribeTableInnerInfo")
...
var fileDescriptor_f723cea3e4fa0cb7 = []byte{
	...
	,
}
