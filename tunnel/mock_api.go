...
// SwitchTunnel mocks base method.
func (m *MockTunnelMetaApi) SwitchTunnel(req *SwitchTunnelRequest) (*SwitchTunnelResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SwitchTunnel", req)
	ret0, _ := ret[0].(*SwitchTunnelResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
